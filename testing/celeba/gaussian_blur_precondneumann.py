...
data_location = "/Users/dgilton/Downloads/img_align_celeba/"


kernel_size = 5
noise_sigma = 0.0000001

# modify this for your machine
save_location = "/share/data/vision-greg2/users/gilton/gaussianblur_precondneumann.ckpt"
save_location = "/Users/dgilton/Desktop/notafile.ckpt"
...
measurement_process = OperatorPlusNoise(forward_operator, noise_sigma=noise_sigma).to(
    device=device
)
...
if os.path.exists(save_location):
    ...
    print(
        "JUST SO YOU KNOW, YOUR CHECKPOINT DOES NOT EXIST. CONTINUING WITH A RANDOMLY-INITIALIZED SOLVER."
    )
